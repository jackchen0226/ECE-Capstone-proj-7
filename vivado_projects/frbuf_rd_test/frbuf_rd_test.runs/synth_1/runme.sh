...
HD_PWD='/home/rwegter/vivado_projects/v_frmbuf_rd_2_ex/v_frmbuf_rd_2_ex.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ex_synth_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ex_synth_wrapper.tcl
