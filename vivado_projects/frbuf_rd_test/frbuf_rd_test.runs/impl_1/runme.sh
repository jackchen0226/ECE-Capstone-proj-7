...
HD_PWD='/home/rwegter/vivado_projects/v_frmbuf_rd_2_ex/v_frmbuf_rd_2_ex.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log ex_synth_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source ex_synth_wrapper.tcl -notrace
