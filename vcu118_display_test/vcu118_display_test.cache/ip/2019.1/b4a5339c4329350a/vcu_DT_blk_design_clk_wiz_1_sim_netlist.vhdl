...
-- Date        : Thu Mar 25 10:44:08 2021
-- Host        : WT-SP4U running 64-bit Ubuntu 20.04.2 LTS
-- Command     : write_vhdl -force -mode funcsim -rename_top decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix -prefix
--               decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_ vcu_DT_blk_design_clk_wiz_1_sim_netlist.vhdl
-- Design      : vcu_DT_blk_design_clk_wiz_1
...
entity decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_vcu_DT_blk_design_clk_wiz_1_clk_wiz is
  port (
...
end decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_vcu_DT_blk_design_clk_wiz_1_clk_wiz;

architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_vcu_DT_blk_design_clk_wiz_1_clk_wiz is
  signal clk_in1_vcu_DT_blk_design_clk_wiz_1 : STD_LOGIC;
  signal clk_out1_vcu_DT_blk_design_clk_wiz_1 : STD_LOGIC;
...
clkin1_ibufds: unisim.vcomponents.IBUFDS
    generic map(
      ...
      I => clk_in1_p,
      IB => clk_in1_n,
      O => clk_in1_vcu_DT_blk_design_clk_wiz_1
    );
clkout1_buf: unisim.vcomponents.BUFGCE
    generic map(
      ...
      SIM_DEVICE => "ULTRASCALE_PLUS"
        ...
        port map (
      CE => '1',
      I => clk_out1_vcu_DT_blk_design_clk_wiz_1,
      O => clk_out1
    );
mmcme4_adv_inst: unisim.vcomponents.MMCME4_ADV
    generic map(
      ...
      CLKIN1 => clk_in1_vcu_DT_blk_design_clk_wiz_1,
      CLKIN2 => '0',
      CLKINSEL => '1',
      CLKINSTOPPED => NLW_mmcme4_adv_inst_CLKINSTOPPED_UNCONNECTED,
      CLKOUT0 => clk_out1_vcu_DT_blk_design_clk_wiz_1,
...
begin
inst: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_vcu_DT_blk_design_clk_wiz_1_clk_wiz
     port map (
      clk_in1_n => clk_in1_n,
      clk_in1_p => clk_in1_p,
      clk_out1 => clk_out1,
