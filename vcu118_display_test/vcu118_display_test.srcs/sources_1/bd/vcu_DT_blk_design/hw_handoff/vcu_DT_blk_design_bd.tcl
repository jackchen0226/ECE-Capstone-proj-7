...
################################################################
# This is a generated script based on design: vcu_DT_blk_design
#
...
# source vcu_DT_blk_design_script.tcl
...
set design_name vcu_DT_blk_design
...
proc create_root_design { parentCell } {
  ...
  # Create instance: mode, and set properties
  set mode [ create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 mode ]
  set_property -dict [ list \
   CONFIG.DIN_FROM {30} \
   CONFIG.DIN_TO {30} \
   CONFIG.DOUT_WIDTH {1} \
  ...
  connect_bd_net -net blue_Dout [get_bd_ports blue] [get_bd_pins blue/Dout]
  connect_bd_net -net c_counter_binary_0_Q [get_bd_pins c_counter_binary_0/Q] [get_bd_pins mode/Din] [get_bd_pins vga_core_0/random_num]
  connect_bd_net -net clk_wiz_0_clk_out1 [get_bd_ports clk] [get_bd_pins c_counter_binary_0/CLK] [get_bd_pins clk_wiz_0/clk_out1] [get_bd_pins vga_core_0/clk_dot]
  connect_bd_net -net green_Dout [get_bd_ports green] [get_bd_pins green/Dout]
  connect_bd_net -net red_Dout [get_bd_ports red] [get_bd_pins red/Dout]
  connect_bd_net -net reset_1 [get_bd_ports reset] [get_bd_pins clk_wiz_0/reset] [get_bd_pins vga_core_0/reset]
  ...
  connect_bd_net -net vga_core_0_vga_pixel_rgb [get_bd_pins blue/Din] [get_bd_pins green/Din] [get_bd_pins red/Din] [get_bd_pins vga_core_0/vga_pixel_rgb]
  connect_bd_net -net vga_core_0_vga_vsync [get_bd_ports vga_vsync] [get_bd_pins vga_core_0/vga_vsync]
  connect_bd_net -net xlslice_0_Dout [get_bd_pins mode/Dout] [get_bd_pins vga_core_0/mode_bit]
  connect_bd_net -net zero_dout [get_bd_pins vga_core_0/color_3b] [get_bd_pins zero/dout]
